(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,76131,t=>{"use strict";let e="#1e3a5f",i=["#10b981","#f59e0b","#3b82f6","#22d3ee","#ef4444","#14b8a6","#0ea5e9","#d97706"],o={info:{bg:"#eff6ff",border:"#bfdbfe",title:"#1e40af"},good:{bg:"#ecfdf5",border:"#a7f3d0",title:"#065f46"},warn:{bg:"#fffbeb",border:"#fde68a",title:"#92400e"}},n=t=>String(t??"—").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),a=(t,i)=>`<h2 style="font-size:13px;color:${e};margin:18px 0 8px;padding-left:8px;border-left:4px solid ${i};">${n(t)}</h2>`;function l(t,i){return`<div style="flex:1;background:${i?e:"#f8fafc"};${i?"color:white;border:none;":"border:1px solid #e5e7eb;"}border-radius:10px;padding:12px;text-align:center;">
