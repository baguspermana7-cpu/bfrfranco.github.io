            ...
            <div className="h-[150px]">
                <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={data} margin={{ top: 5, right: 5, bottom: 0, left: -8 }}>
                        ...
                        <Tooltip formatter={((v: number) => fmtUsd(v)) as never} labelFormatter={(l) => `Year ${l}`} contentStyle={{ background: '#0f1424', border: '1px solid rgba(255,255,255,0.1)', fontSize: 11, borderRadius: 8 }} />
