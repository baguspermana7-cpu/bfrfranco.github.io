    ...
    return (
        <div className="space-y-4 dark:text-slate-100">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-2.5">
                ...
                <KpiCard label="Total OPEX / yr" value={fmtUsd(d.opexAnnual)} sub="DC-contract rate · 100% util" icon={Repeat} accent="blue" series={opexSeries} seriesLabel="Annual OPEX" valueFormat={(n) => `$${(n / 1e6).toFixed(1)}M`} tip="Annualised operating expenditure modelled by the Operations engine: power, staffing, maintenance, licensing. Power is costed at the DC-contract (wholesale/PPA) rate at 100% utilization — this can differ from the standalone OPEX calculator, which uses the retail tariff and a partial utilization factor." />
