...
const FAQ_DATA: FaqItem[] = [
    ...
    { category: 'General', q: 'What are the clickable numbers with a dotted underline (Trace Angka)?', a: 'Any figure with a dotted violet underline can be clicked to open a "Trace Angka" popover: the formula with live values rendered as colored pills (violet = your input, emerald = sourced engine constant, cyan = derived, amber = screening estimate). Click any pill to drill into its own formula — recursively down to the very last input or constant, with "Edit in menu" links and external source links at each leaf.' },
