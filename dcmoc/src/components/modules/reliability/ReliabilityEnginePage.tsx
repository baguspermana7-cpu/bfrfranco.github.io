                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3 md:grid-cols-3 xl:grid-cols-6">
                        {[
                            ...
                            { label: 'Downtime (unplanned)', value: fmtDowntime(model.downtimeMin), sub: `budget ${fmtDowntime(model.budgetMin)}`, trace: 'rel.downtimeMin', tip: 'Expected unplanned downtime per year = (1 − composed availability) × 525,960 min (365.25 d/yr), shown against the tier downtime budget. Exceeding the budget usually traces to a SPOF or a long-MTTR component — the SPOF list and sensitivity table below identify which. Planned maintenance windows are excluded.' },
