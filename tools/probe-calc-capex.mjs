// probe-calc-cx.mjs — v1.17.2 runtime audit for capex-calculator.html
...
(async () => {
  ...
  await page.goto(`http://localhost:8081/capex-calculator.html?nc=${Date.now()}`, { waitUntil: 'domcontentloaded', timeout: 30000 });
  await sleep(500);
  ...
  await mobilePage.goto(`http://localhost:8081/capex-calculator.html?nc2=${Date.now()}`, { waitUntil: 'domcontentloaded', timeout: 30000 });
  await sleep(500);
