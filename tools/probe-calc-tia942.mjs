// probe-calc-tia942.mjs — v1.17.2 runtime audit for tia-942-checklist.html
import puppeteer from 'puppeteer';

const PAGE_URL = `http://localhost:8081/tia-942-checklist.html?nc=${Date.now()}`;
...
(async () => {
  ...
  await page.goto('http://localhost:8081/tia-942-checklist.html', { waitUntil: 'networkidle2' });
  await page.evaluate(() => {
