// probe-calc-carbon.mjs — v1.18.3 runtime audit for carbon-footprint.html
...
(async () => {
  ...
  await page.goto(`http://localhost:8081/carbon-footprint.html?nc=${Date.now()}`, { waitUntil: 'domcontentloaded', timeout: 30000 });
  await sleep(500);
  ...
  await mobilePage.goto(`http://localhost:8081/carbon-footprint.html?nc2=${Date.now()}`, { waitUntil: 'domcontentloaded', timeout: 30000 });
  await sleep(500);
