...
CSS = r"""
    :root:not([data-theme="dark"]) {
        --bg:#f1f5f9; --surface:#ffffff; --surface-2:#f8fafc; --line:rgba(100,116,139,0.28);
        --text:#0f172a; --text-strong:#0b1324; --text-body:#334155; --muted:#64748b;
        --cyan:#0e7490; --amber:#b45309; --green:#047857; --red:#b91c1c; --shadow-deep:rgba(2,6,23,0.12);
    }
    [data-theme="dark"] {
        --bg:#0b1324; --surface:#0f172a; --surface-2:#111a2e; --line:rgba(148,163,184,0.20);
        --text:#e5edf7; --text-strong:#f1f5f9; --text-body:#cbd5e1; --muted:#94a3b8;
        --cyan:#22d3ee; --amber:#f59e0b; --green:#34d399; --red:#f87171; --shadow-deep:rgba(0,0,0,0.5);
    }
    * { box-sizing:border-box; }
    ...
    h1 { font-size:1.8rem; color:var(--text-strong); margin:0.2rem 0 0.4rem; line-height:1.2; }
    h2 { font-size:1.05rem; color:var(--text-strong); margin:1.8rem 0 0.6rem; letter-spacing:0.01em; }
...
SCRIPTS_TMPL = """
    ...
    <script>
    (function(){{var t=document.getElementById('themeToggle');function a(theme){{document.documentElement.setAttribute('data-theme',theme);localStorage.setItem('theme',theme);var m=document.querySelector('meta[name=\\"theme-color\\"]');if(m)m.setAttribute('content',theme==='dark'?'#0b1324':'#f1f5f9');}}a(localStorage.getItem('theme')||'dark');if(t)t.addEventListener('click',function(){{var c=document.documentElement.getAttribute('data-theme');a(c==='dark'?'light':'dark');}});}})();
