...
(async () => {
  ...
  await page.goto(`http://localhost:8081/cx-calculator.html?nc=${Date.now()}`, { waitUntil: 'domcontentloaded', timeout: 30000 });
  await sleep(500);
  ...
  await mobilePage.goto(`http://localhost:8081/cx-calculator.html?nc2=${Date.now()}`, { waitUntil: 'domcontentloaded', timeout: 30000 });
  await sleep(500);
